...
export const project = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: 'The challenge',
      type: 'text', rows: 5,
      description: 'The first of the four turns in the project page\'s left column. What the client came with, and what made it hard.',
    }),
    defineField({ name: 'approach', title: 'Approach', type: 'text', rows: 5 }),
    defineField({ name: 'outcome', title: 'Outcome', type: 'text', rows: 5 }),
    defineField({ name: 'whatWeDid', title: 'What we did', type: 'text', rows: 5,
      description: 'The written turn. The services list below is shown separately, at the foot of the column.' }),
